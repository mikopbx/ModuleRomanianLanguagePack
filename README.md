...
Complete Romanian language pack for MikoPBX including UI translations and voice prompts.

## What's Included

- **Voice Prompts**: Romanian voice prompts for system menus, greetings, and notifications
- **UI Translations**: Complete Romanian translation of MikoPBX admin interface
