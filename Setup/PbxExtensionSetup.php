...
namespace Modules\ModuleRomanianLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Romanian Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Romanian UI translations from Messages/ro/ directory
 * - Romanian voice prompts from Sounds/ro-ro/ directory
 *
 ...
 *
 * @package Modules\ModuleRomanianLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleRomanianLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Romanian packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Romanian Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Romanian Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Romanian Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Romanian Language Pack uninstalled successfully',
            LOG_INFO
        );
