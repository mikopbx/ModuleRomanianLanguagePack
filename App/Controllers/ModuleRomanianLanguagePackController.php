...
namespace Modules\ModuleRomanianLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleRomanianLanguagePackController
 *
 * Controller for Romanian Language Pack module information page
 */
class ModuleRomanianLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleRomanianLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/ro-ro';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/ro';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-romanian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-romanian-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-romanian-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-romanian-language-pack-sounds-index.js", true);
