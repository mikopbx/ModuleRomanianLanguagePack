...
namespace Modules\ModuleRomanianLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleRomanianLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * RomanianLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class RomanianLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-romanian-language-pack';
